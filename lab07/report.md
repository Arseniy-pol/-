...
![photo3. Уравнения для модели варианта-35](photo/8.png "Уравнения для модели варианта-35")

При этом объем аудитории N = 1030, в начальный момент о товаре знает 8 человек. Для случая 2 определите в какой момент времени скорость распространения рекламы будет
...
Уравнения для модели варианта-35:
