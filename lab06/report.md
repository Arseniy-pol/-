...
![код для графика в варианте 35 пункт 1](images/1.png "код для графика в варианте 35 пунтк 1"){ #fig:001 width=90% }

и получил следующий график (Рис [-@fig:002] и [-@fig:003]):

![график в варианте 35 пункт 1 ](images/2.png "график в варианте 35 пункт 1"){#fig:002 width=90%}

![график в варианте 35 пункт 1 ближе](images/3.png "график в варианте 35 пункт 1 ближе"){#fig:003 width=90%}

Чтобы построить график для случая I(0) > I\*, я написал следующий код (Рис [-@fig:004]):

![код для графика в варианте 35 пункт 2](images/4.png "код для графика в варианте 35 пункт 2"){ #fig:004 width=90% }

и получил следующий график (Рис [-@fig:005]):

![график в варианте 35 пункт 2](images/5.png "график в варианте 35 пункт 2"){#fig:005 width=90%}
