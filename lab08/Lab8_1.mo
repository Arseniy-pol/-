model Lab8_1
//[0:0.01:30]
  parameter Real M0_1 = 3.7; // Начальное x1
  ...
  parameter Real tau2 = 17; // Длительность производственного цикла 2 фирмы
  parameter Real p1= 6.7; // Себестоимость продукта фирмы 1
  parameter Real p2 = 11.7; // Себестоимость продукта фирмы 2
